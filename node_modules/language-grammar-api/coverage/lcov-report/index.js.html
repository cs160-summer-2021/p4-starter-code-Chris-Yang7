...
<a name='L47'></a><a href='#L47'>47</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">2x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const Trembita = require('trembita');
&nbsp;
...
const LanguageToolClient = class LanguageToolClient extends Trembita {
  ...
  constructor() {
     ...
     */
    this.languages = <span class="fstat-no" title="function not covered" >()</span> =&gt; {
...
&nbsp;
     ...
     */
    this.check = <span class="fstat-no" title="function not covered" >qu</span>eryStringParams =&gt; {
<span class="cstat-no" title="statement not covered" >      return this.request({</span>
        url: '/check',
        method: 'POST',
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Mar 11 2019 11:20:03 GMT+0100 (CET)
</div>
</div>
